...
/** Icône CTA mobile header — commander une benne */
export function BenneIcon({ className }: BenneIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M8.99219 4V2M4.99219 5L3.49219 3.5M3.99219 9H1.99219M4.99219 13L3.49219 14.5M14.4922 3.5L12.9922 5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
