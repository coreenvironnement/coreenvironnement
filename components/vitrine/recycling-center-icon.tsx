...
type RecyclingCenterIconProps = {
  className?: string
}

/** Icône accès déchetteries professionnelles — services vitrine */
export function RecyclingCenterIcon({ className }: RecyclingCenterIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
